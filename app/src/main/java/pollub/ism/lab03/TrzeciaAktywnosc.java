...
public class TrzeciaAktywnosc extends AppCompatActivity {
    ...
    public void uruchomPierwsza(View view) {
        Intent intencja = new Intent(this, MainActivity.class);     //powrót do MainActivity, którego nie było w instrukcji :)
        startActivity(intencja);                                                  //zrobiony analogicznie do przejścia z Main do Trzeciej Aktywnosci
    }
